...
public class BookController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SuccessResponse> updateById(@PathVariable("id") Long id , @RequestBody @Valid Book book) {
        bookService.updateById(id , book);
        return new ResponseEntity<>(
            new SuccessResponse(null, "Update completed successfully"), HttpStatus.OK);
    }
}